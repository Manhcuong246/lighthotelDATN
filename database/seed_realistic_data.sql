...
UPDATE `hotel_info` SET
  `description` = 'Grand Vista Resort Đà Nẵng tọa lạc ngay trên bãi biển Mỹ Khê – một trong những bãi biển đẹp nhất châu Á theo bình chọn của Forbes. Với 35 phòng và suite được thiết kế tinh tế, mỗi không gian đều hướng tầm nhìn ra biển xanh cát trắng. Resort mang đến trải nghiệm nghỉ dưỡng cao cấp với bể bơi vô cực, spa trị liệu, nhà hàng phục vụ ẩm thực Á – Âu, và đội ngũ nhân viên được đào tạo bài bản. Chúng tôi phục vụ hơn 15.000 lượt khách mỗi năm, với tỷ lệ quay lại trên 40%. Từ khách công tác, cặp đôi tuần trăng mật đến gia đình đa thế hệ – Grand Vista cam kết mang đến kỳ nghỉ đáng nhớ nhất.',
  `rating_avg` = 4.72,
  `updated_at` = NOW()
WHERE `id` = 1;
...
UPDATE `room_types` SET `description` = 'Phòng Standard tại Grand Vista được thiết kế tối giản nhưng đầy đủ tiện nghi 5 sao. Diện tích 28-30m² với giường King-size hoặc 2 giường đơn, chăn ga cotton Ai Cập 500 thread count, điều hòa hai chiều. Phòng hướng vườn nhiệt đới hoặc hồ bơi, có ban công nhỏ lý tưởng cho buổi sáng nhâm nhi cà phê. Phù hợp cho cặp đôi, khách công tác ngắn ngày hoặc du khách tiết kiệm muốn trải nghiệm resort biển mà không phải chi quá nhiều.' WHERE `id` = 1;

UPDATE `room_types` SET `description` = 'Phòng Deluxe là lựa chọn phổ biến nhất của khách lưu trú tại Grand Vista. Diện tích 35m² với ban công rộng hướng biển, cửa kính floor-to-ceiling cho tầm nhìn panorama. Nội thất gỗ óc chó, giường Queen/King, minibar miễn phí và máy pha cà phê Nespresso. Ánh sáng tự nhiên tràn ngập, tiếng sóng vỗ nhẹ nhàng – nơi lý tưởng cho kỳ nghỉ lãng mạn hoặc tuần trăng mật ngắn ngày.' WHERE `id` = 2;

UPDATE `room_types` SET `description` = 'Suite 65m² với phòng khách riêng biệt tách hẳn phòng ngủ, view biển 180 độ. Hai phòng ngủ (1 King + 1 Twin), hai phòng tắm đá cẩm thạch với vòi sen mưa và bồn tắm ngâm. Sofa da Ý, bàn ăn 4 chỗ, TV 55 inch trong phòng khách. Thiết kế phù hợp gia đình 4 người, nhóm bạn đi du lịch hoặc khách muốn không gian như căn hộ cao cấp ngay sát biển Mỹ Khê.' WHERE `id` = 3;
...
UPDATE `rooms` SET `description` = 'Phòng 205 tầng 2, ban công rộng thoáng ngắm trọn bãi Mỹ Khê trải dài. Nội thất gỗ óc chó cao cấp, giường Queen-size lớn, ánh sáng tự nhiên tràn ngập qua cửa kính floor-to-ceiling. Minibar miễn phí, máy pha Nespresso – nơi lý tưởng cho những cặp đôi tìm kiếm sự lãng mạn và riêng tư. Buổi tối ngồi ban công ngắm đèn thuyền đánh cá trên biển là trải nghiệm khó quên.' WHERE `id` = 2;
...
UPDATE `rooms` SET `description` = 'Junior Suite 402 view pháo hoa (khi có sự kiện), không gian mở, giường King + sofa bed, phòng tắm mưa. Phù hợp dịp lễ hội hoặc kỷ niệm đặc biệt. Đêm giao thừa hoặc lễ hội pháo hoa Đà Nẵng, view từ phòng rất tuyệt. Nên đặt sớm cho các dịp lễ.' WHERE `id` = 24;
...
(13, 15, 5, 'Gần gym, tiện cho người hay tập', 'Mình hay đi công tác Đà Nẵng, lần nào cũng đặt phòng 104 vì gần phòng gym. Sáng dậy chạy bộ 5 phút ra biển rồi về tập. Phòng sạch, giường êm. Nhân viên dọn phòng kỹ.', NULL, NULL, '2025-01-17 09:45:00', '2025-01-17 09:45:00'),
...
(22, 22, 5, 'VIP Jacuzzi – kỷ niệm 10 năm cưới', 'Đặt phòng 503 cho dịp kỷ niệm. Jacuzzi ngoài trời view hoàng hôn quá tuyệt. Nhân viên trang trí hoa và bánh trong phòng. Cảm động lắm. Cảm ơn Grand Vista!', 'Chúc mừng anh chị 10 năm hạnh phúc! Rất vinh dự được phục vụ.', '2025-06-13 14:00:00', '2025-06-13 11:30:00', '2025-06-13 14:00:00'),
...
(29, 29, 5, 'VIP 504 – sinh nhật vợ', 'Đặt bất ngờ cho vợ. Nhân viên trang trí phòng và bánh. Jacuzzi view biển. Vợ rất cảm động. Cảm ơn team Grand Vista!', 'Chúc mừng sinh nhật chị! Chúc gia đình hạnh phúc.', '2025-10-08 09:30:00', '2025-10-08 10:20:00', '2025-10-08 09:30:00'),
...
(31, 15, 5, 'Standard 104 – công tác 3 đêm', 'Đi họp ở Đà Nẵng. Phòng gần lobby, tiện. View hồ bơi. Sạch sẽ. Bữa sáng có sớm từ 6h cho khách đi sớm.', NULL, NULL, '2025-12-05 08:45:00', '2025-12-05 08:45:00'),
