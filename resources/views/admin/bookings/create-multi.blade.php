            ...
            <div class="card-body py-3">
                <div class="d-flex align-items-start gap-2">
                    ...
                    <p class="small text-muted mb-0">
                        <strong class="text-body">Một đơn chỉ cần một người đại diện.</strong>
                        Bạn đã chọn ${roomCount} phòng — nhập họ tên và CCCD ở khối &quot;Người đại diện đặt phòng&quot; phía trên (dùng chung cho cả đơn).
                    </p>
                </div>
            </div>
        </div>
