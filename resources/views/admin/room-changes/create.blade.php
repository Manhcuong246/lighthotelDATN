...
<div class="container-fluid py-4">
    ...
    @else
    @php
        $oldRoomForPricing = $currentBookingRoom->room ?? null;
        $oldCatalogueBase = $oldRoomForPricing ? (float) $oldRoomForPricing->catalogueBasePrice() : 0.0;
    @endphp
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    @else
        ...
        const oldCatalogueBase = @json($oldCatalogueBase);
