...
<div class="container-fluid px-3 px-lg-4">
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-4">
        ...
        <div class="d-flex gap-2">
            <a href="{{ route('admin.room-changes.create') }}" class="btn btn-primary rounded-2">
    ...
    <div class="card shadow-sm border-0 rounded-3 mb-4">
        <div class="card-header bg-white border-0 py-3">
            <div class="d-flex align-items-center justify-content-between">
                ...
                <a href="{{ route('admin.room-changes.index') }}" class="btn btn-sm btn-outline-secondary rounded-2">Xóa lọc</a>
            </div>
        </div>
        <div class="card-body">
            <form method="GET" action="{{ route('admin.room-changes.index') }}" class="row g-3">
                ...
                <div class="col-md-2">
                    <label class="form-label">Chênh lệch giá</label>
                ...
                <div class="col-md-2">
                    <label class="form-label">Loại đổi phòng</label>
                ...
                <table class="table table-hover mb-0 align-middle">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.bookings.show', $h->booking_id) }}" class="text-decoration-none">
                                    #{{ $h->booking_id }}
                                </a>
                                @if($h->booking)
                            ...
                            <td class="text-center pe-3">
                                <a href="{{ route('admin.room-changes.show', $h->id) }}" class="btn btn-sm btn-outline-info rounded-2" title="Chi tiết">
                                    <i class="bi bi-eye"></i>
                                </a>
                            </td>
                        </tr>
