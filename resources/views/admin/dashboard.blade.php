...
<div class="container-fluid">
    ...
    <!-- Thống Kê Doanh Thu & Tỉ Lệ Lấp Phòng -->
    <div class="row mb-4">
        <div class="col-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex justify-content-between align-items-center">
                    <h6 class="m-0 fw-bold">📊 THỐNG KÊ CHI TIẾT</h6>
                    <a href="{{ route('admin.statistics.index') }}" class="btn btn-sm btn-primary">Xem chi tiết →</a>
                </div>
                <div class="card-body">
                    <div class="row">
                        <!-- Doanh thu tháng này -->
                        <div class="col-md-3 mb-3">
                            <div class="p-3 border rounded" style="background: #f8f9fa;">
                                <small class="text-muted d-block mb-1">Doanh Thu Tháng Này</small>
                                <h4 class="mb-0 text-success">{{ number_format($monthlyRevenue, 0, ',', '.') }} đ</h4>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3 mb-3">
                            <div class="p-3 border rounded" style="background: #f8f9fa;">
                                <small class="text-muted d-block mb-1">Tỉ Lệ Lấp Phòng Hôm Nay</small>
                        ...
                        <div class="col-md-3 mb-3">
                            <div class="p-3 border rounded" style="background: #f8f9fa;">
                                <small class="text-muted d-block mb-1">Tỉ Lệ Lấp Phòng Tháng Này</small>
                                <h4 class="mb-0 text-warning">{{ $monthlyOccupancyRate }}%</h4>
                            </div>
                        </div>

                        <!-- Đơn đặt phòng hôm nay -->
                        <div class="col-md-3 mb-3">
                            <div class="p-3 border rounded" style="background: #f8f9fa;">
                                <small class="text-muted d-block mb-1">Đặt Phòng Hôm Nay</small>
                                <h4 class="mb-0 text-secondary">{{ $todayBookings }} đơn</h4>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-3 mb-3">
                            <div class="p-3 border rounded" style="background: #f8f9fa;">
                                <small class="text-muted d-block mb-1">Đặt Phòng Tháng Này</small>
                                <h4 class="mb-0 text-dark">{{ $monthlyBookings }} đơn</h4>
                            </div>
                        </div>
                        ...
                        <div class="col-md-9 mb-3">
                            <div class="p-3 border rounded" style="background: #f8f9fa;">
                                <small class="text-muted d-block mb-1">Doanh Thu Tổng Cộng</small>
                                <h4 class="mb-0" style="color: #e74a3b;">{{ number_format($totalRevenue, 0, ',', '.') }} đ</h4>
                            </div>
                        </div>
                    </div>
                </div>
