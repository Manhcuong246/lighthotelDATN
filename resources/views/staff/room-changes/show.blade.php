...
<div class="container-fluid px-3 px-lg-4">
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-4">
        ...
        <div class="d-flex gap-2">
            <a href="{{ route('staff.room-changes.index') }}" class="btn btn-outline-secondary btn-sm rounded-2">
    ...
    <div class="row g-4">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-2">
                                ...
                                <span class="fw-bold">#{{ $history->booking_id }}</span>
                            </div>
                            <div class="mb-2">
        ...
        <!-- Cột phải: Lý do, ngườii đổi, lịch sử -->
        <div class="col-lg-4">
            <!-- Lý do -->
            <div class="card shadow-sm border-0 rounded-3 mb-4">
                <div class="card-header bg-white border-0">
            ...
            <div class="card shadow-sm border-0 rounded-3 mb-4">
                <div class="card-header bg-white border-0">
                    <h5 class="mb-0 fw-bold"><i class="bi bi-person me-2"></i>Ngườii thực hiện</h5>
                </div>
                <div class="card-body">
            ...
            <div class="card shadow-sm border border-warning rounded-3 mb-4">
                ...
                <div class="card-body">
                    ...
                    <a href="{{ route('staff.damage-reports.show', $history->damageReport) }}" class="btn btn-sm btn-outline-warning mt-2">
                        Xem chi tiết
                    </a>
                </div>
            </div>
            ...
            <div class="card shadow-sm border-0 rounded-3">
                ...
                <div class="card-body p-0">
                    <div class="list-group list-group-flush">
                        ...
                        <a href="{{ route('staff.room-changes.show', $bh->id) }}" class="list-group-item list-group-item-action">
...
<div class="modal fade" id="revertModal" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="{{ route('staff.room-changes.revert', $history->id) }}" method="POST">
                @csrf
                @method('POST')
